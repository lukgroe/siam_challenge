classdef MarketSimulator_copy < handle
   properties
   ...
   methods
      function obj = MarketSimulator_copy(T,s0,paramStruct, w_prev_in)
          obj.w_prev = w_prev_in;
      ...
      function obj = step(obj,w)
         ...
         if obj.t==1
             w_delta = obj.w_prev - obj.w_hist(:,1);  %only change, for correct calculation of return
         else
